  ...
  if (x.style.display === "none") {
    ...
    //native version (new)
    x.innerHTML = ` <img src="images/close.svg" class= "player-close" onclick="unwrapPlayer(this)" /> <video width='100%' height='100%' controls autoplay>   <source src="${vidLink}" type='video/mp4; codecs="avc1.42E01E, mp4a.40.2"'></video> ";`
